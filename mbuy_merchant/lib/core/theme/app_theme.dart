...
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    MBUY MERCHANT - Alibaba Style Theme                    ║
// ║                                                                           ║
...
class AppTheme {
  ...
  // Text Colors
  // ============================================================================
  static const Color textPrimaryColor = Color(0xFF191919); // Almost Black
  static const Color textSecondaryColor = Color(0xFF666666); // Grey Text
  static const Color textHintColor = Color(0xFF999999); // Light Grey
  ...
  static const Color surfaceDarkAccent = Color(0xFF2D2D2D);
  static const Color iconBgDark = Color(0xFF2D2D2D);
  static const Color shadowColor = Color(0x1A000000); // 10% black

  // ============================================================================
  // App Store Colors (Using Alibaba Theme)
  // ============================================================================
  static const Color appStoreBackground = Color(0xFFF5F5F5);
  static const Color appStoreSurface = Color(0xFFFFFFFF);
  static const Color appStoreBorder = Color(0xFFE8E8E8);
  static const Color appStoreCard = Color(0xFFFFFFFF);
  static const Color appStorePrimary = Color(0xFFFF6A00); // Alibaba Orange
  static const Color appStoreTextPrimary = Color(0xFF191919);
  static const Color appStoreTextSecondary = Color(0xFF666666);
  static const Color appStoreTextMuted = Color(0xFF999999);
  static const Color appStoreStar = Color(0xFFFFB800); // Gold
  ...
  static Color activeColor(bool isDark) => primaryColor;

  static Color inactiveColor(bool isDark) =>
      isDark ? textHintColorDark : textHintColor;

  static Color shadow(bool isDark) => isDark ? Colors.black45 : shadowColor;
  ...
  // ============================================================================
  // Additional Dark Mode aliases (for compatibility)
  // ============================================================================
