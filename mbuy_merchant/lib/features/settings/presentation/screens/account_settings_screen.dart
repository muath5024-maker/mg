                ...
                children: [
                  ...
                  _buildSettingsCard([
                    _buildActionTile(
                      ...
                      onTap: () =>
                          context.push('/dashboard/notification-settings'),
                    ),
                    const Divider(height: 1),
                    _buildSwitchTile(
                      icon: AppIcons.notifications,
                  ...
                  _buildSettingsCard([
                    _buildActionTile(
                      ...
                      onTap: () =>
                          context.push('/dashboard/appearance-settings'),
                    ),
                    const Divider(height: 1),
                    _buildDropdownTile(
                      icon: AppIcons.globe,
                  ...
                  _buildSettingsCard([
                    _buildActionTile(
                      ...
                      onTap: () => context.push('/dashboard/privacy-policy'),
                    ),
                    const Divider(height: 1),
                    _buildActionTile(
                      icon: AppIcons.document,
                      title: 'شروط الاستخدام',
                      onTap: () => context.push('/dashboard/terms'),
                    ),
                  ]),
