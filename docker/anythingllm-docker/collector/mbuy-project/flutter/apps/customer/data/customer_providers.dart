...
class FavoritesNotifier extends Notifier<FavoritesState> {
  ...
  Future<void> loadFavorites() async {
    ...
    final response = await _api.favorites.getFavorites();
  ...
  Future<bool> toggleFavorite(String productId) async {
    final response = await _api.favorites.toggleFavorite(productId);
  ...
  Future<bool> addToFavorites(String productId) async {
    final response = await _api.favorites.addToFavorites(productId);
  ...
  Future<bool> removeFromFavorites(String productId) async {
    final response = await _api.favorites.removeFromFavorites(productId);
...
class OrdersNotifier extends Notifier<OrdersState> {
  ...
  Future<void> loadOrders({String? status}) async {
    ...
    final response = await _api.orders.getOrders(status: status, page: 1, limit: 20);
  ...
  Future<void> loadMore() async {
    ...
    final response = await _api.orders.getOrders(
  ...
  Future<bool> cancelOrder(String orderId) async {
    final response = await _api.orders.cancelOrder(orderId);
...
final orderProvider = FutureProvider.family<Order?, String>((
  ...
  final api = ref.watch(customerApiProvider);
  final response = await api.orders.getOrder(orderId);
...
class CheckoutNotifier extends Notifier<CheckoutState> {
  ...
  Future<void> loadAddresses() async {
    ...
    final response = await _api.orders.getAddresses();
  ...
  Future<bool> validateCheckout() async {
    ...
    final response = await _api.orders.validateCheckout();
  ...
  Future<String?> placeOrder({
    ...
    final response = await _api.orders.createOrder(
...
final addressesProvider = FutureProvider<List<ShippingAddress>>((ref) async {
  final api = ref.watch(customerApiProvider);
  final response = await api.orders.getAddresses();
...
final homeBannersProvider = FutureProvider<List<Map<String, dynamic>>>((
  ...
  final api = ref.watch(customerApiProvider);
  final response = await api.banners.getHomeBanners();
  return response.ok ? response.data ?? [] : [];
});
