...
class _CategoryProductsScreenState
  ...
  Widget _buildProductCard(Map<String, dynamic> product, bool isDark) {
    ...
    final boostType = product['boost_type'] as String?;
    final productId = product['id'] as String? ?? '';
    final merchant = product['merchants'] as Map<String, dynamic>?;
    final storeName = merchant?['name'] as String? ?? '';

    // Calculate discount
    final hasDiscount = compareAtPrice != null && compareAtPrice > price;
    final originalPrice = compareAtPrice ?? 0.0;
