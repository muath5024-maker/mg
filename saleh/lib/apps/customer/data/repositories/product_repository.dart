...
class ProductRepository extends BaseRepository implements IProductRepository {
  ...
  Future<Result<List<Product>>> getProducts({
    ...
    return _getCachedOrFetch(
      cacheKey,
      () => api.getProducts(categoryId: categoryId, page: page, limit: limit),
    );
  }
  ...
  Future<Result<List<String>>> getSearchSuggestions(String query) async {
    final response = await api.getSearchSuggestions(query);
    return toResult(response);
  }
  ...
  Future<Result<List<Product>>> getTrendingProducts({int limit = 20}) async {
    ...
    return _getCachedOrFetch(
      cacheKey,
      () => api.getTrendingProducts(limit: limit),
    );
  }
  ...
  Future<Result<List<Product>>> getProductsByCategory(
    ...
    return _getCachedOrFetch(
      cacheKey,
      () => api.getProductsByCategory(categoryId, page: page, limit: limit),
    );
  }
